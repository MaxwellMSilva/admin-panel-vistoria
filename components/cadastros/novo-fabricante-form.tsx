...
import { Factory, Edit3, Loader2 } from "lucide-react"
      ...
      {fabricante ? (
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2 mb-2">
                <h3 className="text-lg font-semibold text-blue-900">Editando Fabricante</h3>
              ...
              <div className="grid grid-cols-1 gap-3 text-sm">
                <div>
                  ...
                  <p className="text-blue-900 font-medium">{fabricante.descricao}</p>
                </div>
              </div>
              <div className="mt-3 p-2 bg-blue-100 rounded-md">
                <p className="text-xs text-blue-700">
                  💡 <strong>Dica:</strong> Você está editando o fabricante "{fabricante.descricao}". A nova descrição
                  substituirá a atual.
                </p>
              </div>
            </div>
        ...
        <div className="bg-gradient-to-r from-green-50 to-emerald-50 border border-green-200 rounded-lg p-4 mb-6 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-green-900">Novo Fabricante</h3>
              <p className="text-sm text-green-700">
                Preencha a descrição abaixo para criar um novo fabricante no sistema.
              </p>
            </div>
          </div>
        </div>
