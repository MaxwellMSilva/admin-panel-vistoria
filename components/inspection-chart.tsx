    ...
    return (
      <Card className={cn(className, "border-none shadow-md")}>
        <CardHeader>
          ...
          <CardDescription>Acompanhe o desempenho das vistorias.</CardDescription>
        </CardHeader>
        <CardContent>
        ...
        <Tabs defaultValue="daily" className="space-y-4">
          ...
          <TabsContent value="daily" className="space-y-4">
            <div className="h-[300px] rounded-md bg-muted/40 flex items-center justify-center relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <ChartIcon />
                <p className="ml-2 text-muted-foreground">Vistorias por Hora</p>
              </div>
          ...
          <TabsContent value="weekly" className="space-y-4">
            <div className="h-[300px] rounded-md bg-muted/40 flex items-center justify-center relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <ChartIcon />
                <p className="ml-2 text-muted-foreground">Vistorias por Dia</p>
              </div>
              <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-primary/10 to-transparent"></div>
            </div>
          </TabsContent>
          <TabsContent value="monthly" className="space-y-4">
            <div className="h-[300px] rounded-md bg-muted/40 flex items-center justify-center relative overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <ChartIcon />
                <p className="ml-2 text-muted-foreground">Vistorias por Mês</p>
              </div>
              <div className="absolute bottom-0 left-0 right-0 h-40 bg-gradient-to-t from-primary/10 to-transparent"></div>
            </div>
          </TabsContent>
